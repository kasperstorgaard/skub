...
export function SolutionDialog(
  ...
  const isOpen = dialog === "solution" || (hasSolution && !savedName && dialog !== "celebrate");
  ...
  return (
    <Dialog open={isOpen}>
      <div className="flex flex-col gap-fl-2 text-text-2">
        ...
        <p>{savedName ? "Claim your solve to see how others did it." : "Pick a name and see how others did it."}</p>
      </div>
