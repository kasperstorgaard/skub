...
// TODO: investigate CI failures — name not visible on solutions page after submit (deploy preview)
Deno.test({
  name:
    "a new user discovers the tutorial, plays their first puzzle, and submits their name",
  ignore: true,
  fn: async () => {
...
Deno.test({
  name:
    "without JavaScript — a new user solves a puzzle and submits their name",
  ignore: true,
  fn: async () => {
